...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3971019968ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tables récentes" class="drop_button btn">Récentes</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestions_des_installations&table=installation">`gestions_des_installations`.`installation`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestions_des_installations&table=gps">`gestions_des_installations`.`gps`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestions_des_installations&table=facture">`gestions_des_installations`.`facture`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestions_des_installations&table=commande">`gestions_des_installations`.`commande`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestions_des_installations&table=cat_vehicule">`gestions_des_installations`.`cat_vehicule`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestions_des_installations&table=client">`gestions_des_installations`.`client`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestions_des_installations&table=suivi">`gestions_des_installations`.`suivi`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestions_des_installations&table=vehicule">`gestions_des_installations`.`vehicule`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestions_des_installations&table=compte">`gestions_des_installations`.`compte`</a></li></ul></div><div class="drop_list"><button title="Tables préférées" class="drop_button btn">Préférées</button><ul id="pma_favorite_list"><li class="warp_link">Pas de tables préférées.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="225d457129673d552f2d7c2753312f75">
